...
public class TrieTest {
	...
	// This test also makes sure it doesn't return true just because the input is a
	// prefix of a word that exists.
	@Test
	...
	public void testSearchResultSortOrder() {
		List.of("azalia", "aardvark", "abacus", "alchemy", "adagio", "hem", "hew", "hi", "bye", "acquiesce")
	...
	// Empty tree lookups should return correct values.
	@Test
	public void testEmptyTree() {
		assertThat(trie.search("a").size()).isEqualTo(0);
		assertThat(trie.contains("a")).isFalse();
	}
	
	// Assumed requirement: Empty string throws IllegalArgumentException
	@Test
	...
	// Assumed requirement: null string throws NullPointerException
	@Test
